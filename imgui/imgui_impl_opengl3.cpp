...
#define IMGL3W_IMPL
#if defined(IMGUI_IMPL_OPENGL_LOADER_IMGL3W)
#include "imgui_impl_opengl3_loader.h"
#else
// About Desktop OpenGL function loaders:
//  Modern desktop OpenGL doesn't have a standard portable header file to load OpenGL function pointers.
//  Helper libraries are often used for this purpose! Here we are supporting a few common ones (gl3w, glew, glad).
//  You may use another loader of your choice (e.g. SDL_GL_GetProcAddress, glbinding, glext, etc), or chose to manually implement your own loader.
//  Just define IMGUI_IMPL_OPENGL_LOADER_XXX and make sure your loader is included before this.
#if defined(IMGUI_IMPL_OPENGL_LOADER_GL3W)
#include <GL/gl3w.h>            // Needs to be initialized with gl3wInit() in user's code
#elif defined(IMGUI_IMPL_OPENGL_LOADER_GLEW)
#include <GL/glew.h>            // Needs to be initialized with glewInit() in user's code
#elif defined(IMGUI_IMPL_OPENGL_LOADER_GLAD)
#include <glad/glad.h>          // Needs to be initialized with gladLoadGL() or gladLoadGLLoader() in user's code
#elif defined(IMGUI_IMPL_OPENGL_LOADER_GLAD2)
#include <glad/gl.h>            // Needs to be initialized with gladLoadGL() or gladLoadGLLoader() in user's code
#elif defined(IMGUI_IMPL_OPENGL_LOADER_GLBINDING2) || defined(IMGUI_IMPL_OPENGL_LOADER_GLBINDING3)
#include <glbinding/gl/gl.h>
using namespace gl;             // Needs to be initialized with glbinding::initialize() in user's code
#else
#error Please define an OpenGL loader: IMGUI_IMPL_OPENGL_LOADER_GL3W/IMGUI_IMPL_OPENGL_LOADER_GLEW/IMGUI_IMPL_OPENGL_LOADER_GLAD/IMGUI_IMPL_OPENGL_LOADER_GLAD2/IMGUI_IMPL_OPENGL_LOADER_GLBINDING2/IMGUI_IMPL_OPENGL_LOADER_GLBINDING3/IMGUI_IMPL_OPENGL_LOADER_CUSTOM
#endif
#endif
#endif
